...
class ModelArguments:
    ...
    results_path: Optional[str] = field(
        default='/mnt/data/lisa/LLM_results/VQ_dora3_8B_2b_bucket4_rank64',
        metadata={"help": "results path for optimized VQ dora"},
    )
    ...
    lora_num_ranks: int = field(default=64)
    lora_dropout: float = field(default=0.0)
    lora_config: Optional[str] = field(default='lora-lpq')
    lora_model_name: Optional[str] = field(default='nf2')
...
def main(return_trainer: bool = False):
    ...
    set_seed(42) # default TrainingArgs seed in huggingface
    ...
    torch.save(state_dict, os.path.join(model_args.results_path, 'full_model.pth'))
    model.save_pretrained(model_args.results_path, from_pt=True)
    breakpoint()
