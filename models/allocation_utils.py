...
PATH_ILP = '/mnt/data/lisa/LLM_pretrained_models/lq-lora/'
FILE_NAMES_DICT = {
    # 7B
    "llama-2-7b/lpq-64/c4"  : PATH_ILP + "ilp_data_fp32/llama-2-7b-1024.ilp.ranks-64.data-True.pth",
    "llama-2-7b/lpq-64/None": PATH_ILP + "ilp_data_fp32/llama-2-7b-1024.ilp.ranks-64.data-False.pth",
    "llama-2-7b/lora/c4"    : PATH_ILP + "ilp_data_fp32/llama-2-7b-1024.ilp.ranks-None.data-True.pth",
    "llama-2-7b/lora/None"  : PATH_ILP + "ilp_data_fp32/llama-2-7b-1024.ilp.ranks-None.data-False.pth",
    # 70B
    "llama-2-70b/lpq-64/c4"  : PATH_ILP + "ilp_data_bf16/llama-2-70b-1024.ilp.ranks-64.data-True.pth",
    "llama-2-70b/lpq-64/None": PATH_ILP + "ilp_data_bf16/llama-2-70b-1024.ilp.ranks-64.data-False.pth",
    "llama-2-70b/lora/c4"    : PATH_ILP + "ilp_data_bf16/llama-2-70b-1024.ilp.ranks-None.data-True.pth",
    "llama-2-70b/lora/None"  : PATH_ILP + "ilp_data_bf16/llama-2-70b-1024.ilp.ranks-None.data-False.pth",
}
...
def create_qconfig_and_sensitivity_dict_LLaMA(
    ...
    print(FILE_NAMES_DICT[file_name_identifier])
